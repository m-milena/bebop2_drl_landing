...
#                  < Publishers > 
    pub = rospy.Publisher('bebop_leader/cmd_vel', Twist, queue_size=1)
    pub_takeoff = rospy.Publisher('bebop_leader/takeoff', Empty, queue_size=10)
    pub_land = rospy.Publisher('bebop_leader/land', Empty, queue_size=10)
    pub_camera=rospy.Publisher('bebop_leader/camera_control', Twist, queue_size=1)
